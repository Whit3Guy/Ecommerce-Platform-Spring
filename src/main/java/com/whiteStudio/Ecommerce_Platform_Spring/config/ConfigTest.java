...
public class ConfigTest implements CommandLineRunner {
    ...
    @Autowired
    private ProductRepository _rePr;
    ...
    public void run(String... args) throws Exception {
        ...
        Product p1 = new Product(null, "RaspBerryPi 400", "é mt top", 12.90, "url qualquer", c1);
        Product p2 = new Product(null, "Enxada", "Farmadora de dinheiros", 9.70, "url qualquer", c2);
        ...
        _rePr.saveAll(new ArrayList<>(Arrays.asList(p1,p2)));
    }
}
